...
import (
	"github.com/calam1/programming_in_go_book/stacker/stack"
	"testing"
)
...
func TestStack(t *testing.T) {
	...
	count++
	assertTrue(t, aStack.Cap() == 0, "expected empty Stack", count)
	count++
	assertTrue(t, aStack.IsEmpty(), "expected empty Stack", count)
	count++
